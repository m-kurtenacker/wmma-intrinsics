...
query1 = df.query('target == "7900-xtx" and name == "tiled"').assign(ks=-1, sk=-1, pb=-1).groupby(by=["target", "name", "pb", "ks", "sk", "x", "y", "wx", "wy", "lb"])
query2 = df.query('target == "7900-xtx" and name == "blocked"').groupby(by=["target", "name", "pb", "ks", "sk", "x", "y", "wx", "wy", "lb"])
query3 = df.query('target == "7900-xtx" and name == "wmma"').assign(x=-1, y=-1, wx=-1, wy=-1, ks=-1, sk=-1).groupby(by=["target", "name", "pb", "ks", "sk", "x", "y", "wx", "wy", "lb"])
...
print()
print("Best individual runs on 7900 xtx")
print(result1.head(15))
print(result2.head(15))
print(result3.head(15))

result_xtx = pd.concat([result1, result2, result3]).sort_values("time")
